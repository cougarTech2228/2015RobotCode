 ...
 * GUESS what DOESN'T belong here: ports, like IDs and connection indices (ex) pwm ports) this stuff belongs in robotMap
 * GUESS what DOES belong here: config ex) ramp rate, joystick settings, button mappings
 */
